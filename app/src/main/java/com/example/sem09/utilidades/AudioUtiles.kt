package com.example.sem09.utilidades
...
import com.example.sem09.Manifest
...
class AudioUtiles(
    ...
    private fun grabaDetiene(){
        if(ContextCompat.checkSelfPermission(contexto, android.Manifest.permission.RECORD_AUDIO) != PackageManager.PERMISSION_GRANTED){
